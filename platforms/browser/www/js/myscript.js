var global_id, global_pid, global_uid;//, test;

//test = "testing cookies";
...
function sign_up() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=1&username=" + username + "&password=" + password + "&phone=" + phone + "&payment=" + payment;
...
function login() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=2&username=" + username + "&password=" + password;
    //url = "52.89.116.249";
    //window.location.href = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php";
    obj = send_request(url);
...
function add_pool() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=3&name=" + name + "&seats=" + seats + "&date=" + date + "&time=" + time + "&cost=" + cost + "&dest=" + destination + "&dep=" + departure + "&cid=" + global_id;
    obj = send_request(url);
...
function get_my_pools() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=4&id=" + global_id;
...
function get_all_pools() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=5&id=" + global_id;
...
function get_a_pool(id) {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=6&id=" + id;
...
function get_data_for_update(pid) {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=6&id=" + pid;
...
function update_pool() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=10&name=" + name + "&seats=" + seats + "&date=" + date + "&time=" + time + "&cost=" + cost + "&dest=" + dest + "&dep=" + dep + "&pid=" + global_uid;
...
function join(pid) {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=7&uid=" + uid + "&pid=" + pid;
...
function get_joined_pools() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=8&uid=" + uid;
...
function leave_pool() {
    ...
    url = "http://52.89.116.249/~samuel.agyeman/server-side/controller.php?cmd=9&pid=" + global_pid + "&uid=" + global_id;
